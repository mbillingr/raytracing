...
(define ground-material (make-material
                          (checkers-pattern (color 0.8 0.8 0.8)
                                            (color 0.2 0.2 0.2))
                          0.1 0.9 0.0 100.0 0.2))

(define ceiling-material (make-material
                           (color 0.8 0.8 1)
                           0.9 0.9 0.0 100.0 0.0))
...
(middle 'set-material! (make-material
                         (color 0 0 0)
                         0.0 0.0 1.0 200.0 1.0))
...
(call-with-output-file "chapter11.ppm"
  (lambda (f)
