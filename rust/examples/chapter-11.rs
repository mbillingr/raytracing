...
fn main() {
    ...
    let floor_material = Phong::new_pattern(
        checkers_pattern(color(0.75, 0.25, 0.5), color(0.25, 0.75, 0.5)),
        0.25,
        0.9,
        0.0,
        100.0,
    ...
    let middle = sphere()
        ...
        .with_material(Phong::new(color(0, 0, 0), 0.0, 0.0, 0.8, 200.0, 1.0));
    ...
    let left = sphere()
        ...
        .with_material(Phong::new(color(1, 0.8, 0.1), 0.1, 0.7, 0.3, 200.0, 0.25));
